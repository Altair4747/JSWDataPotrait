...
public class Example : MonoBehaviour {
    ...
    public void sendEmail()
    {
        ...
        SimpleEmailSender.emailSettings.UserName = "rakshitasthana17@gmail.com";
        SimpleEmailSender.emailSettings.UserPass = "ytprgjijgxczjrpg";

       // SimpleEmailSender.Send(To.text, Subject.text, Body.text, AttachFile.text, SendCompletedCallback);
        SimpleEmailSender.Send(To.text, "Paani aur tera Chera", "Your Beautiful Pic from Local Computer", GameManager.Instance.file, SendCompletedCallback);
    }
